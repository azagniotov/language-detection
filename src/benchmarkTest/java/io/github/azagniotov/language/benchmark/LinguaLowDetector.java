...
public class LinguaLowDetector implements ThirdPartyDetector {
  ...
  private LinguaLowDetector(final LanguageDetector languageDetector) {
  ...
  public static ThirdPartyDetector from(final String iso639_1CodesCsv) {
    ...
    final LanguageDetector languageDetector =
        LanguageDetectorBuilder.fromLanguages(languageArgs).withLowAccuracyMode().build();
    return new LinguaLowDetector(languageDetector);
  }
