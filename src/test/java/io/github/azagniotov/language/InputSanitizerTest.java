...
public class InputSanitizerTest {
    ...
    public void shouldRemoveNonWordCharacters() {
        ...
        assertEquals(filterOutNonWords("I'm reading a book right now."), "I m reading a book right now ");
        ...
        assertEquals(filterOutNonWords("Sie sagte: 'Ich bin beschäftigt!'"), "Sie sagte   Ich bin beschäftigt  ");
    ...
    public void shouldPerformCombinedSanitization() {
        ...
        assertEquals(filterOutNonWords(sanitizeForSearch("in1729x01_J-LCM刷新プロジェクト.docx")), "in1729x01 J LCM刷新プロジェクト");
        assertEquals(
        ...
        assertEquals(filterOutNonWords(sanitizeForSearch("#4_pj_23D002_HCMJ_デジ戦")), "4 pj 23D002 HCMJ デジ戦");
    }
}
