...
public class LanguageDetectionOrchestratorTest {
    ...
    @Test
    public final void detectsNullInput() throws Exception {
    ...
    @Test
    public final void detectsEmptyInput() throws Exception {
        final LanguageDetectionOrchestrator orchestrator = new LanguageDetectionOrchestrator(SETTINGS);
    ...
    @Test
    public final void detectsBlankInput() throws Exception {
        final LanguageDetectionOrchestrator orchestrator = new LanguageDetectionOrchestrator(SETTINGS);
        final Language language = orchestrator.detect(" ");
    ...
    @Test
    public final void detectsAnyCjkInputAsJapanese() throws Exception {
        final LanguageDetectionSettings settings = LanguageDetectionSettings.fromIsoCodes639_1(ISO_CODES)
    ...
    @Test
    public final void doesNotDetectsLatinInputAsJapanese() throws Exception {
        final LanguageDetectionSettings settings = LanguageDetectionSettings.fromIsoCodes639_1(ISO_CODES)
                .withClassifyChineseAsJapanese()
                .build();
    ...
    @Test
    public final void detectsLanguage() throws Exception {
        final LanguageDetectionOrchestrator orchestrator = new LanguageDetectionOrchestrator(SETTINGS);
        ...
        assertEquals(
                "ja", orchestrator.detect("ﾊｰﾄﾞｶﾌﾟｾﾙ(ｻｲｽﾞ3号 NATURAL B／C).pdf").getIsoCode639_1());
        ...
        assertEquals(
                "zh-cn", orchestrator.detect("【12.21s】【流山運動公園：流山市市野谷】【中村P：3台】").getIsoCode639_1());
        ...
        assertEquals(
                "zh-cn",
                orchestrator
                        .detect("位于美国首都华盛顿都会圈的希望中文学校５日晚举办活动庆祝建立２０周年。"
    ...
    @Test
    public final void detectsAll() throws Exception {
        final LanguageDetectionOrchestrator orchestrator = new LanguageDetectionOrchestrator(SETTINGS);

        final List<Language> languages = orchestrator.detectAll(" deel te neem, om die kunste te geniet en in weten");
    ...
    @Test
    public final void detectsLanguageWithMaxTextCharsLimit() throws Exception {
        final LanguageDetectionSettings settings = LanguageDetectionSettings.fromIsoCodes639_1(ISO_CODES)
                .withMaxTextChars(5)
                .build();
    ...
    @Test
    public final void detectsLanguageWithAndWithoutInputSanitizationForSearch() throws Exception {
        final LanguageDetectionSettings settingsWithoutSearchSanitize = LanguageDetectionSettings.fromIsoCodes639_1(
                        ISO_CODES)
                .withoutSanitizeForSearch()
                .build();

        LanguageDetectionOrchestrator orchestrator = new LanguageDetectionOrchestrator(settingsWithoutSearchSanitize);
        assertEquals("fr", orchestrator.detect("Ｃｕｌｔｕｒｅ　ｏｆ　Ｊａｐａｎ.pdf").getIsoCode639_1());
        assertEquals(
                "fr", orchestrator.detect("ﾊｰﾄﾞｶﾌﾟｾﾙ(ｻｲｽﾞ3号 NATURAL B／C).pdf").getIsoCode639_1());
