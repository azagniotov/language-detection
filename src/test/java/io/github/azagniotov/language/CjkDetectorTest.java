...
public class CjkDetectorTest {
    ...
    public void shouldDetectJapaneseInput() throws Exception {
        ...
        assertEquals(CjkDetector.decide(s("      東      A     京   "), DEFAULT_THRESHOLD), DECISION_JAPANESE);
        ...
        assertEquals(CjkDetector.decide(s("東 A 京 B に C 行 D き E ま F し G た "), DEFAULT_THRESHOLD), DECISION_JAPANESE);
        ...
        assertEquals(CjkDetector.decide(s("七月の報告 1234567890.pptx"), DEFAULT_THRESHOLD), DECISION_JAPANESE);
        assertEquals(CjkDetector.decide(s("七月の報告 １２３４５６７８９０.pptx"), DEFAULT_THRESHOLD), DECISION_JAPANESE);
    ...
    public void shouldDetectChineseInput() throws Exception {
        ...
        assertEquals(CjkDetector.decide(s("麵最终报告 1234567890.pdf"), DEFAULT_THRESHOLD), DECISION_CHINESE);
    ...
    public void shouldNotDetectInputAsChinese() throws Exception {
        ...
        assertNotEquals(CjkDetector.decide(s("      東      A     京   "), DEFAULT_THRESHOLD), DECISION_CHINESE);
        ...
        assertNotEquals(CjkDetector.decide(s("東 A 京 B に C 行 D き E ま F し G た "), DEFAULT_THRESHOLD), DECISION_CHINESE);
    ...
    public void shoulddetectJapaneseInput_RealQueries_Threshold_0_5() throws Exception {
        ...
        assertEquals(CjkDetector.decide(s("【12.21s】【流山運動公園：流山市市野谷】【中村P：3台】"), threshold), DECISION_JAPANESE);
        assertEquals(CjkDetector.decide(s("ﾊｰﾄﾞｶﾌﾟｾﾙ(ｻｲｽﾞ3号 NATURAL B／C)"), threshold), DECISION_JAPANESE);
    }
    ...
    public void shoulddetectJapaneseInput_RealQueries_Threshold_0_2() throws Exception {
        ...
        assertEquals(CjkDetector.decide(s("(Ts-Hf3 OR Hf-PAH) AND (気化器"), threshold), DECISION_JAPANESE);
