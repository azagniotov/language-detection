...
public class LanguageDetectionSettings {
    ...
    private static final String ALL_SUPPORTED_ISO_CODES_639_1 =
            "af,ar,bg,bn,br,ca,cs,cy,da,de,el,en,es,et,fa,fi,fr,gu,he,hi,hr,hu,id,it,ja,kn,ko,lb,lt,lv,mk,ml,mr,ne,nl,no,pa,pl,pt,"
    ...
    public static Builder fromIsoCodes639_1(final String isoCodes639_1csv) {
        final List<String> isoCodes639_1 = Arrays.stream(isoCodes639_1csv.split(COMMA))
    ...
    public static class Builder {
        ...
        public Builder withMininumCertainty(final double certaintyThreshold, final String fallbackIsoCode639_1) {
