...
final class InputSanitizer {
    ...
    private static final Pattern PATTERN_NOT_A_WORD = Pattern.compile("\\P{IsWord}", Pattern.UNICODE_CHARACTER_CLASS);
    ...
    private static final Pattern COMBINED_PATTERN = Pattern.compile(String.format(
            "%s|%s|%s", FILENAME_EXTENSION_ANYWHERE, SOLR_BOOLEAN_QUERIES, SUBSET_LATIN_PUNCTUATION_MARKS));
